...
class MockConfigStore:
    def __init__(self, domain: str = "civitai.com"):
        self.domain = domain
...
class CivitaiCacheUrlTests(unittest.TestCase):
    def test_cached_civitai_urls_are_normalized_to_default_domain(self) -> None:
        ...
        record = manager.load_cached_check({
            ...
            "items": [{
                "modelId": "6424",
                "modelUrl": "https://civitai.red/models/6424",
                "versionUrl": "https://civitai.red/models/6424?modelVersionId=11745",
                "remoteVersions": [{
                    "versionId": "11745",
                    "versionUrl": "https://civitai.red/models/6424?modelVersionId=11745",
                }],
        ...
        item = record.items[0]
        self.assertEqual("https://civitai.com/models/6424", item["modelUrl"])
        self.assertEqual("https://civitai.com/models/6424?modelVersionId=11745", item["versionUrl"])
        self.assertEqual(
            "https://civitai.com/models/6424?modelVersionId=11745",
            item["remoteVersions"][0]["versionUrl"],
        )

    def test_cached_civitai_urls_are_normalized_to_configured_domain(self) -> None:
        mock_config = MockConfigStore("civitai.red")
